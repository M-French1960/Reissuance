...
return [
    ...
    'complement' => [
        ...
        'what' => 'The officer needs a clearer :piece.',
        'piece_id_document' => 'photograph of your identity document',
        'piece_selfie' => 'photograph of your face',
        'asked_on' => 'Asked on :date.',
        'officer_says' => 'What the officer wrote',
        'tips_title' => 'Taking a photograph that will be accepted',
        'tip_flat' => 'Lay the document flat on a dark surface, in daylight.',
        'tip_corners' => 'All four corners must be visible, with no glare on the number.',
        'tip_still' => 'Hold still: a blurred photograph will be refused again.',
        'file' => 'The new photograph',
        'file_hint' => 'JPEG, PNG or PDF.',
        'send' => 'Send the document',
        'replaces_title' => 'What sending it changes',
        'replaces_body' => 'The new photograph replaces the previous one, which is deleted. A refused identity document is not kept.',
        'restarts_body' => 'The identity checks start again from the beginning: the officer re-examines everything on the document you are sending, not on the previous one.',
        'no_old_photo' => 'The refused photograph is not shown beside the new one: it has been deleted, because an identity document that was not accepted is not kept.',
        'banner_title' => 'A document is needed',
        'banner_body' => 'The officer needs a clearer document before your file can move on.',
        'banner_action' => 'Send the document',
    ],
];
